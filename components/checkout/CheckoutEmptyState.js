/* ─────────────────────────────────────────────
   CheckoutEmptyState
   Empty cart guard for the checkout page.
   Refined, premium, brand-consistent —
   mirrors EmptyCartState aesthetic language.
───────────────────────────────────────────── */
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-6 py-24 md:py-32">
      <div className="text-center max-w-sm mx-auto animate-slide-up">
        ...
        {/* Eyebrow */}
        <p className="section-label justify-center mb-4">Checkout</p>
        ...
        <p className="text-[#8B7D74] text-sm font-light leading-relaxed mb-10">
          Add some pieces to your collection before proceeding to checkout.
        </p>
        ...
        <div className="mt-5">
          <Link href="/">
            <a
              className="
                text-[#8B7D74] text-xs font-light tracking-wide
