        ...
        <div className="flex items-center justify-center">
            <div className="px-4 2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 w-96 sm:w-auto">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="w-11/12 mt-4 text-base leading-normal text-center text-gray-600 lg:w-1/2 md:w-10/12">If you're looking for random paragraphs, you've come to the right place. When a random word or a random sentence isn't quite enough</p>
                </div>
